<script setup>
import GroupTableHeader from '@/pages/cms/adp/admin/GroupsComponent/GroupsTableHeader.vue'
import GroupTable from '@/pages/cms/adp/admin/GroupsComponent/GroupsTable.vue'
