<script setup>
import PermissionTableHeader from '@/pages/cms/adp/admin/PermissionsComponents/PermissionTableHeader.vue'
import PermissionTable from '@/pages/cms/adp/admin/PermissionsComponents/PermissionTable.vue'
